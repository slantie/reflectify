...
export default function PreviewFeedbackForm({
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-primary-lighter to-white py-16">
            <div className="max-w-8xl mx-auto px-8">
                {/* Header Section */}
                <div className="mb-16">
                    <div className="flex justify-between items-start">
                        <div className="space-y-4">
                            <h1 className="text-5xl font-bold text-secondary-darker">
                                {form.title}
                            </h1>
                       ...
                       text-secondary-dark hover:text-secondary-darker font-medium"
                        >
                            Return to Dashboard
                        </button>
                    </div>
                ...
                <div className="grid grid-cols-10 gap-8">
                    ...
                    <div className="col-span-2">
                      ...
                      ${
                          selectedBatch === batch
                              ...
                              : "bg-secondary-lighter text-secondary-dark hover:bg-secondary-lighter"
                      }`}
                                    >
                    ...
                    <div className="col-span-8 space-y-8">
                        ...
                        {form.questions.filter(
                            (q) => getQuestionBatch(q.text) === "None"
                        ).length > 0 && (
                            <section className="bg-white rounded-2xl shadow-sm p-8">
                                <h2 className="text-2xl font-bold text-secondary-darker mb-8">
                                    Theory Questions
                                </h2>
                                <div className="space-y-8">
                                    {form.questions
                                        .filter(
                                            (q) =>
                                                getQuestionBatch(q.text) ===
                                                "None"
                                        )
                                        .map((question, index) => (
                                            <div
                                                key={question.id}
                                                className="border-b border-secondary-lighter last:border-0 pb-8 last:pb-0"
                                            >
                                                <h3 className="text-xl font-medium text-secondary-darker">
                                                    ...
                                                    {question.isRequired && (
                                                        <span className="text-negative-main ml-2">
                                                            *
                                                        </span>
                                                    )}
                                                </h3>
