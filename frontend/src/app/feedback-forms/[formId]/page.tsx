...
export default function FeedbackFormTemplate() {
    ...
    return (
        <div className="min-h-screen bg-secondary-lighter py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="space-y-8">
                    {/* Header Section */}
                    <div className="flex justify-between items-start">
                        <div>
                            <h1 className="text-4xl font-bold text-secondary-darker">
                                Feedback Forms
                            </h1>
                        ...
                        <button
                            ...
                            className="px-6 py-3 bg-primary-dark text-white rounded-lg hover:bg-primary-dark 
                        ...
                        {filteredAndSortedForms.map((form) => (
                            ...
                            >
                                <div className="p-6 space-y-4">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h3 className="text-xl font-semibold text-secondary-darker">
                                                {form.title}
                                            </h3>
                                            <p className="text-sm text-secondary-lighter0 mt-1">
                                                Division:{" "}
                                                {form.division.divisionName}
                                            </p>
                                        </div>
                                ...
                                : "bg-warning-lighter text-warning-dark"
                                    ...
                                    <div className="text-sm text-secondary-dark space-y-1">
                                        <p>
                                            Faculty:{" "}
                                            {
                                                form.subjectAllocation.faculty
                                                    .name
                                            }
                                        </p>
                                        <p>
                                            Subject:{" "}
                                            {
                                                form.subjectAllocation.subject
                                                    .name
                                            }
                                        </p>
                                    ...
                                    <div className="flex justify-end gap-2 pt-4 border-t border-secondary-lighter">
                                        <button
                                            onClick={() =>
                                                router.push(
                                            ...
                                            className="p-2 text-primary-dark hover:bg-primary-lighter rounded-lg transition-colors"
                                            title="Edit Form"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="p-2 text-highlight1-dark hover:bg-highlight1-lighter rounded-lg transition-colors"
                                            title="Preview Form"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="p-2 text-negative-main hover:bg-negative-lighter rounded-lg transition-colors"
                                            title="Delete Form"
                                        >
