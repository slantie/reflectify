...
export default function EditFeedbackForm({
  ...
  const handleFormStatusUpdate = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.success(
          statusMessages[editedForm?.status as keyof typeof statusMessages],
          { duration: 3000, icon: "✅" }
        );
        await fetchForm();
      } else {
  ...
  const fetchLists = useCallback(async () => {
    ...
    try {
      const [facultiesRes, subjectsRes, categoriesRes] = await Promise.all([
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      const deletedQuestions = originalQuestions.filter(
        (origQ) => !currentQuestions.find((currQ) => currQ.id === origQ.id)
      );
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    <select
                      ...
                      onChange={(e) =>
                        handleStatusChange(
                          e.target.value as FormStatusUpdate["status"]
                        )
                      }
                      className="w-full p-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-orange-500 
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <DatePicker
                      ...
                      minDate={new Date()}
                      customInput={
                        <input className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-orange-500" />
                      }
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <DatePicker
                      selected={
                        editedForm.endDate ? new Date(editedForm.endDate) : null
                      }
                      onChange={(date) =>
                        handleDateChange("endDate", date as Date)
                      }
                      showTimeSelect
                      timeFormat="HH:mm"
                      timeIntervals={15}
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="font-medium">{editedForm.title}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium">{editedForm.questions.length}</p>
                </div>
              </div>
            </Card>
          </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        hover:border-gray-300 focus:border-orange-500 focus:outline-none"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <select
                        ...
                        className="p-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-orange-500"
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        />
                        <span className="text-gray-700">Required Response</span>
                      </label>
                    </div>
                  </div>
                </Card>
