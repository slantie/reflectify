...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen lg:flex-row bg-gradient-to-br from-orange-50 via-white to-orange-50">
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-orange-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl text-lg font-semibold transition-all hover:from-orange-600 hover:to-orange-700 focus:ring-2 focus:ring-orange-500/50 shadow-lg shadow-orange-500/30"
              >
                Sign In
              </motion.button>
            </form>
