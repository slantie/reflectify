    ...
    const calculateStats = (subjectData: Subject[]) => {
        const stats = {
            ...
            mandatorySubjects: subjectData.filter((s) => s.type === "MANDATORY")
                .length,
            electiveSubjects: subjectData.filter((s) => s.type === "ELECTIVE")
                .length,
        };
        ...
        return subjects
            .filter((s) => {
                ...
                const matchesSemester = selectedSemester
                    ? s.semester?.semesterNumber?.toString() ===
                      selectedSemester
                    : true;
          ...
          />
            ...
            <div className="flex gap-6 items-center bg-white p-5 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.08)] border border-secondary-lighter">
                <div className="flex-1 relative">
                    ...
                    />
                    <BookOpenIcon className="h-5 w-5 text-secondary-main absolute left-3 top-3" />
                </div>
                                            ...
                                            <span
                                                className={`px-2 py-1 rounded-full text-xs font-medium ${
                                                    subject.type === "MANDATORY"
                                                        ? "bg-highlight1-lighter text-highlight1-dark"
                                                        : "bg-highlight2-lighter text-highlight2-dark"
                                                }`}
                                            >
                                                {subject.type}
                                            </span>
                                ...
                                <tr>
                                    ...
                                    >
                                        <div className="flex flex-col items-center justify-center space-y-2">
                                            <BookOpenIcon className="h-8 w-8 text-secondary-light" />
