  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div suppressHydrationWarning className="fixed inset-0 overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-200 p-2.5 focus:border-orange-300 focus:ring-2 focus:ring-orange-100"
                    />
                  </div>
                  ...
                  <div className="flex justify-end gap-3 mt-6">
                    ...
                    <button
                      type="submit"
                      className="px-4 py-2 text-sm font-medium text-white bg-orange-400 rounded-lg hover:bg-orange-500"
                    >
                      Add Subject
                    </button>
                  </div>
