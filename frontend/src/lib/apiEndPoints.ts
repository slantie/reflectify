...
export const DASHBOARD_SUBJECT = `${API_URL}/subjects`;
export const DASHBOARD_SEMESTER = `${API_URL}/semesters`;
export const DASHBOARD_FACULTY = `${API_URL}/faculties`; 
...
export const DASHBOARD_DIVISIONS_CREATE = `${API_URL}/divisions`;
export const SUBJECT_SEMESTER = `${API_URL}/subjects/semester`;
export const QUESTION_CATEGORIES = `${API_URL}/feedback-questions/categories`;
...
export const FEEDBACK_FORM_GENERATE = `${API_URL}/feedback-forms/generate`;
export const FEEDBACK_QUESTIONS_FORMS = `${API_URL}/feedback-questions/form`; 
