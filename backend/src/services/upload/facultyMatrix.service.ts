...
class FacultyMatrixUploadService {
  ...
  public async processFacultyMatrix(
    ...
    formData.append('facultyMatrix', fileBuffer, {
      filename: 'facultyMatrix.xlsx', // Generic filename, adjust if originalname is preferred
      contentType:
        'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', // Explicitly set content type
    });
